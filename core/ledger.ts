...
export const LEDGER_EVENT_TYPES = [
  ...
  'LESSON_STATUS_CHANGED', 'LESSON_VALIDATED', 'KNOWLEDGE_ADOPTED', 'KNOWLEDGE_STATUS_CHANGED',
  'MODEL_EVALUATED', 'IMPROVEMENT_PROPOSED', 'IMPROVEMENT_APPROVED', 'IMPROVEMENT_REJECTED',
] as const;
