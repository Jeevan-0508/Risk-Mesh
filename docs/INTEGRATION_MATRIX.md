...
| risk-replay | Real FastAPI backend, 13 engines, SQLAlchemy persistence | MESH's only candidate for a genuinely live adapter — call the real API for replay requests on MESH-tracked decisions | PLANNED |
